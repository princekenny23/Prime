...
const supplierOptions: SupplierOptionCard[] = [
  {
    id: "suppliers",
    title: "Suppliers",
    href: "/dashboard/office/suppliers/list",
    icon: Building2,
    bgColor: "bg-blue-900",
  ...
  },
  {
    ...
    href: "/dashboard/office/suppliers/purchase-orders",
    icon: ShoppingCart,
    bgColor: "bg-gray-100",
  ...
  },
  {
    ...
    href: "/dashboard/office/suppliers/invoices",
    icon: FileText,
    bgColor: "bg-blue-900",
    iconColor: "text-white",
    textColor: "text-white",
  ...
  },
  {
    ...
    href: "/dashboard/office/suppliers/returns",
    icon: RotateCcw,
    bgColor: "bg-gray-100",
    iconColor: "text-gray-700",
    textColor: "text-foreground",

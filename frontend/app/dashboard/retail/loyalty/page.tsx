      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{totalPoints.toLocaleString('en-US')}</div>
            </CardContent>
          </Card>
              ...
              {loyaltyProgram.tiers.map((tier, idx) => (
                <div key={idx} className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground mb-1">
                    Min Points: {tier.minPoints.toLocaleString('en-US')}
                  </p>
                  ...
                  <TableRow key={customer.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold">{customer.points.toLocaleString('en-US')}</span>
                      </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell className="font-semibold">
                      MWK {customer.totalSpent.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                    </TableCell>
                    <TableCell>
                      <Button
                        variant="outline"
